      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#151520] rounded-2xl border border-white/[0.04] p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-700 hover:bg-gray-50 hover:shadow-md py-3 rounded-xl text-sm font-medium transition-all mb-4 border border-gray-200 active:scale-[0.98]"
          >
