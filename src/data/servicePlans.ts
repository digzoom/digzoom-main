...
export const servicePlans: ServicePlan[] = [
  ...
  {
    id: "growth-system",
    nameAr: "إدارة متكاملة",
    nameEn: "Integrated Management",
    price: 4990,
    summaryAr:
      "إدارة الموقع ومنصتين والمحتوى وصفحات المنتجات والقياس ضمن اشتراك واحد.",
    summaryEn:
      "Website, two platforms, content, product pages, and measurement in one plan.",
    resultAr:
      "موقع ومنصات ومحتوى تُدار بجدول واحد، مع تقرير يوضح ما نُفذ وما يحتاج تحسينًا.",
    resultEn:
      "A website, channels, and content managed to one schedule with clear reporting.",
    bestForAr:
      "مناسبة لمن يريد إدارة الموقع ومنصتين والمحتوى والمنتجات والقياس مع فريق واحد.",
    bestForEn:
      "Best for a business that wants one team to manage its website, two platforms, content, products, and measurement.",
    productsAr: "يشمل تجهيز 5 منتجات شهريًا",
    productsEn: "Includes 5 product listings monthly",
    countingAr: [
      "12 منشورًا و12 قصة هي مواد إجمالية تُهيّأ وتُنشر على المنصتين، وليست لكل منصة.",
      "المقطعان القصيران يشملان المونتاج من صور أو مقاطع يقدمها العميل؛ التصوير الميداني غير مشمول.",
      "صفحات المنتجات الخمس تشمل تنسيق البيانات والصور وكتابة وصف أساسي جاهز للنشر.",
      "تحديثات الموقع تخص الصفحات القائمة؛ إعادة التصميم أو البرمجة الكبيرة تُسعّر منفصلًا.",
    ],
    countingEn: [
      "12 posts and 12 stories are total assets adapted and published across both platforms, not per platform.",
      "The 2 short videos are edited from client-supplied footage or images; filming is excluded.",
      "The 5 product pages include data and image formatting plus basic publish-ready copy.",
      "Website updates apply to existing pages; redesigns and major development are quoted separately.",
    ],
    includedAr: [
      "إدارة الموقع ومنصتين يختارهما العميل",
      "12 منشورًا مصممًا و12 قصة مصممة",
      "كتابة المحتوى والجدولة والنشر",
      "مونتاج مقطعين قصيرين من مواد العميل",
      "تجهيز 5 صفحات منتجات جاهزة للنشر",
      "تحديث العروض والمحتوى في الصفحات القائمة",
      "إعداد قياس التحويلات واجتماع وتقرير شهري",
    ],
    includedEn: [
      "Website and 2 selected platforms",
      "12 designed posts and 12 designed stories",
      "Copywriting, scheduling, and publishing",
      "Editing 2 short videos from client assets",
      "5 publish-ready product pages",
      "Offer and content updates on existing pages",
      "Conversion tracking, monthly call, and report",
    ],
    clientAr: [
      "توفير الصلاحيات والمواد الأساسية",
      "تحديد مسؤول اعتماد واحد",
      "اعتماد الخطة خلال يومي عمل",
      "توفير معلومات المنتجات الصحيحة",
    ],
    clientEn: [
      "Provide access and core assets",
      "Assign one approver",
      "Approve the plan within 2 business days",
      "Provide accurate product information",
    ],
    digzoomAr: [
      "خطة تنفيذ موحدة",
      "النشر والتحديث وفق الجدول",
      "ربط الأداء بالأهداف",
      "توضيح الأعمال والنتائج دون أرقام مصطنعة",
    ],
    digzoomEn: [
      "One execution plan",
      "Publish and update to schedule",
      "Connect performance to goals",
      "Report work honestly without invented metrics",
    ],
    limitsAr: [
      "ميزانية الإعلان منفصلة",
      "لا ضمان لرقم مبيعات محدد",
      "التصوير الميداني غير مشمول",
      "حصة المنتجات لا تتراكم",
    ],
    limitsEn: [
      "Ad spend is separate",
      "No guaranteed sales figure",
      "On-location photography excluded",
      "Product capacity does not roll over",
    ],
  },
  {
